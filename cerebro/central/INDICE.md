...
| Ler um quadro de fora | `cerebro/acesso-de-fora` | Link de leitura para painéis (Google Planilhas/IMPORTDATA, Looker, Power BI, JSON); parâmetros de filtro, datas relativas, totais; o link é senha (troca/revoga); a IA não cria | ✅ | ✍️ |
