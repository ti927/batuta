...
>
> **Duas consequências disso, aprendidas no dia 21/09/2026 e agora garantidas pelo motor.** A primeira: se o agente decide o caminho, a documentação dele precisa **conhecer os caminhos** — um agente cujo markdown não cita os nomes das saídas conversa, refaz o material, publica e nunca declara nada, e a execução fica parada para sempre com tudo aprovado. O motor não conserta isso (a decisão é do agente, por desenho), mas **denuncia**: repetiu duas rodadas sem decidir, sai um alarme nomeando o agente e os caminhos que ele ignorou. A segunda: a mesma espera tem **duas portas** (a tela e o canal), e as duas mexem na mesma execução — por isso a execução passou a ter um **dono** enquanto alguém responde, e quem chega em segundo lugar recebe uma recusa que explica o porquê, em vez de atropelar um trabalho em voo.
>
> E nenhuma espera fica invisível: cada uma tem **prazo próprio**. Vencido o prazo, o time é avisado uma vez de que aquilo está parado há tanto tempo. O aviso **não encerra nada** — esperar dias por uma aprovação é legítimo; o que não é legítimo é ninguém ficar sabendo.
...
- **A mesma contrapartida tem uma segunda metade, descoberta em 2026-09-21: o agente também precisa saber o que fazer DEPOIS que a pessoa responde.** Quando a aprovação chega, é ele quem declara por qual caminho o fluxo segue. Se a documentação dele não citar os nomes das saídas daquele passo, ele faz todo o trabalho — refaz, publica, agenda — e nunca declara: a execução fica parada ali para sempre, aprovada. Foi assim que uma execução de quase quatro horas ficou presa. Regra que fica: **todo agente que pede aprovação num passo com mais de uma saída precisa ter, no markdown, o nome exato de cada saída e quando usá-la**; e se o passo alimenta dois caminhos ao mesmo tempo, precisa mandar declarar os dois. O motor denuncia quando isso falta, mas não substitui.
