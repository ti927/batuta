...
## FASE FUTURA — Batuta-MCP profissional (o claude.ai opera o Batuta inteiro pela assinatura do consultor)  ▶️ EM EXECUÇÃO (2026-08-21) — Fatia 0 ✅ NO AR/provada; Fatia 1 ✅ NO AR/provada; Fatia 2 ✅ NO AR/provada; Fatia 3a ✅ código pronto (credenciais/chaves esqueleto, 37 tools, 16 testes); próxima = Fatia 3b (org/membros/config-memória/exclusão/duplicação)
...
- **Fatia 3 — As áreas "tudo".** Feita POR PARTES.
  ...
  - **Fatia 3b — organização + membros + config de memória do agente + `icone`/`credencial_id` de instrumento + exclusão/duplicação de time/automação. ◀ PRÓXIMA.** Estas SIM pedem extração de rota→serviço (não mexem em cofre); cuidado com as que só existem nas rotas hoje.
