...
## PROGRAMA — Unificação de Estado (motor + IA criadora)  🔨 PRIORIDADE Nº 1 — Marco 0 ✅ + DECISÃO ✅ (dois trilhos, Frente B primeiro). **Frente B 100% COMPLETA (A–E) ✅ NO AR** (2026-07-27). **Frente A EM EXECUÇÃO: Fatias 1, 2, 3(parte segura), 4.1 e 4.2 ✅ NO AR** (2026-08-04); a Fatia 4.3 (a cura — memória entre turnos) é a próxima, com decisão de arquitetura à parte. Cada fatia com aprovação, uma por vez
...
### Frente A — Unificação do Runtime (remodelagem simplificadora do motor)  🔨 EM EXECUÇÃO — Fatias 1, 2, 3(parte segura), 4.1 e 4.2 ✅ NO AR; Fatia 4.3 (a cura) é a próxima
...
### Frente B — Economia de tokens da IA criadora (resumo rolante `projeto.md` + iceberg + cache)  🔨 EM EXECUÇÃO — Partes D (cache) + A (resumo/janela) + C (busca no histórico) ✅ NO AR (2026-07-26); B/E pendentes
